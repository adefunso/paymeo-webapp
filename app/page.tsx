    ...
    const testimonials = [
      {
        name: "Chioma",
        role: "Shopper, Lagos",
        content: "I needed a specific Ankara style. Posted a request with a small bounty. Within an hour, three sellers sent offers. Picked the best, picked it up the next morning. No stress."
      },
      {
        name: "Tunde",
        role: "Shopper, Ibadan",
    ...
    >
      <Card className="bg-white border border-[#c4d4ff] rounded-2xl">
        <CardContent className="p-4 sm:p-6">
          <p className="text-sm text-gray-700 mb-4">&quot;{testimonial.content}&quot;</p>
          <div>
...
<section className="relative overflow-hidden min-h-screen flex flex-col justify-between" id="meo" ref={meoRef}>
  ...
  UNDERSTANDS YOUR CUSTOMERS LIKE YOU DO
      ...
      <p className="text-white/90 text-xs sm:text-sm md:text-base leading-relaxed">
        Meo is your dedicated <span className="text-[#1e5aff]">24/7</span> Sales AI Agent built to understand, engage, and convert intent into sales for you.<br className="hidden sm:block"/>
...
<section id={activeTab === "personal" ? "more-features" : "how-it-works"}
  ref={activeTab === "personal" ? featuresRef : howItWorksRef} className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-10 bg-white overflow-hidden">
